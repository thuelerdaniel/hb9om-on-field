...
export default function PreloadHint({ activeLayers, isLoading }) {
  ...
  return (
    <div className="absolute top-64 left-1/2 -translate-x-1/2 z-[10001] bg-white rounded-lg shadow-xl border border-blue-200 px-3.5 py-2.5 max-w-md w-[calc(100%-1.5rem)] flex items-start gap-2.5">
