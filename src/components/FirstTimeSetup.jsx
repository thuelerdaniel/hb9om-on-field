        ...
        {!showWarning ? (
          <div className="p-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-3 py-2.5 text-sm border border-gray-200 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 font-mono uppercase"
              />
            ...
            {!usesClubCredentials && (
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Für APRS-Relais und Private Nodes auf der Karte</p>
                <input
                  type="password"
                  value={aprsApiKey}
          ...
          <div className="p-5 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Einschränkungen beachten</h3>
                <p className="text-xs text-gray-500 mt-1">Folgende Module sind ohne diese Angaben eingeschränkt nutzbar:</p>
              </div>
            </div>
            ...
            <p className="text-xs text-gray-500">Sie können diese Angaben jederzeit in den Einstellungen nachtragen.</p>
