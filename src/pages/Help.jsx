...
export default function Help() {
  ...
  const handleDownloadFlyer = async () => {
    ...
    try {
      await generateFlyer();
      toast({ title: "Flyer heruntergeladen", description: "HB9OM On Field Flyer (v0.9006)", duration: 3000 });
    } catch (e) {
      // ignore
    } finally {
  ...
  const handleDownloadTrifold = async () => {
    ...
    try {
      ...
      toast({ title: "Faltflyer heruntergeladen", description: "HB9OM On Field Faltflyer (v0.9006)", duration: 3000 });
    } catch (e) {
      // ignore
    } finally {
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[10px] text-green-100">Info-Flyer v0.9006</p>
            </div>
          </button>
          <button
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-[10px] text-green-100">Trifold v0.9006</p>
            </div>
          </button>
        </div>
