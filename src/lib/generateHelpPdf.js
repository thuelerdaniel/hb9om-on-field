...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Cloud-Backup (WebDAV)", body: "In den Einstellungen unter «Datensicherung» können Sie Ihre WebDAV-Zugangsdaten (URL, Benutzername, Passwort) hinterlegen. Unterstützt werden Nextcloud, ownCloud, Synology und alle WebDAV-kompatiblen Clouds. Bei aktiviertem automatischem Backup wird bei jedem neuen QSO ein Backup in Ihre Cloud hochgeladen. Die bisherige manuelle Backup-Funktion (JSON-Download) bleibt bestehen." },
