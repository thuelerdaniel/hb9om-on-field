...
export async function generateFlyer(options = {}) {
  ...
  doc.setFontSize(8);
  doc.setFont("helvetica", "normal");
  doc.text("hb9om.ch  ·  Amateurfunk Referenzkarte & QSO-Logbuch  ·  v0.9007", W / 2, H - 8, { align: "center" });
  ...
  const exclusives = [
    ...
    "BrandMeister API-Integration: DMR-Relais, Talkgroups und Crosslinks weltweit",
    "RepeaterBook API-Token: automatischer Relais-Sync trotz Cloudflare-Schutz",
    "Admin: API-Key-Verwaltung (QRZ, APRS.fi, BrandMeister, RepeaterBook) — global und pro Admin",
    "Admin: Club-Rufzeichen zentral verwaltet (HB9OM) mit eigenem QRZ-API-Key",
    "Admin: Täglicher E-Mail-Report pro Admin anpassbar mit separater E-Mail-Adresse",
  ...
  doc.setFont("helvetica", "bold");
  doc.setFontSize(11);
  doc.text("hb9om.online", W / 2, y + 34, { align: "center" });
